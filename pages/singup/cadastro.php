        ...
        <div class="container py-5 h-50">
            <div class="row d-flex align-items-center justify-content-center h-100">
                <div class="col-md-8 col-lg-7 col-xl-6">
                    <img src="../../assets\images\loginimg.svg" class="img-fluid" alt="Imagem Cadastro">
                </div>
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    ...
                    <form method="post">
                        ...
                        <div class="divider d-flex flex-row justify-content-between my-4">
                            ...
                            <div>
                                <a class="btn btn-light btn-lg btn-block" href="login.php" role="button"><i class="fa-solid fa-arrow-left"></i> Voltar</a>
                            </div>
                        </div>
                    </form>
